...
/**
   ...
   * @param startDate id to set employee startDate.
   * @param endDate id to set employee endDate.
   * @param noOfday id to set employee noOfdays.
   * @param leaveType id to set employee leaveType.
   * @param leaveReason id to set employee leaveReason.
   * @param leaveId id to set employee leaveReason.
   * @param empId id to set employee leaveReason.
   * @throws ParseException throws Parse Exception
   * @return String
   */
  ...
  public static String updateLeave(final int empId,
    ...
    int prevDays = leavedetails.getLeaveNdays();
    if (employ != null) {
      SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
     ...
     // int overl = LeaveDetails.countNo(empId, startDate, endDate);
      ...
      updLeave = day - counts;
      int bal = (int) updLeave;
      if (empId != leavedetails.listById(leaveId).getEmpId()) {
