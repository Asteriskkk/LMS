...
public interface LeaveDetailsDAO {
   ...
   * @param days the id of the LeaveDetails
   * @param ltype the id of the LeaveDetails
   * @param lstatus the id of the LeaveDetails
   * @param reason the id of the LeaveDetails
   * @param leaveid the id of the LeaveDetails
   */
  @SqlUpdate("UPDATE LEAVE_DETAILS SET START_DATE = :startDate, END_DATE = :endDate,"
