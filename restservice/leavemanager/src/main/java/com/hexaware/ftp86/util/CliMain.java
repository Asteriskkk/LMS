  ...
  private void updateLeave() {
    ...
    while (true) {
      ...
      try {
        ...
        LeaveDetails.listById(leaveid).getEmpId();
        System.out.println(LeaveDetails.listById(leaveid).getEmpId());
        break;
    ...
    String r = null;
    try {
      r = LeaveDetails.updateLeave(empid, sDate,
